...
public class vp_Timer : MonoBehaviour
{
	...
	public static void In(float delay, Action callback, Handle timerHandle = null)
	{ Schedule(delay, callback, null, null, timerHandle, 1, -1.0f); }

	// time + callback + iterations + [timer handle]
	public static void In(float delay, Action callback, int iterations, Handle timerHandle = null)
	{ Schedule(delay, callback, null, null, timerHandle, iterations, -1.0f); }

	// time + callback + iterations + interval + [timer handle]
	public static void In(float delay, Action callback, int iterations, float interval, Handle timerHandle = null)
	{ Schedule(delay, callback, null, null, timerHandle, iterations, interval); }

	// time + callback + arguments + [timer handle]
	public static void In(float delay, Action<object> callback, object arguments, Handle timerHandle = null)
	{ Schedule(delay, null, callback, arguments, timerHandle, 1, -1.0f); }

	// time + callback + arguments + iterations + [timer handle]
	public static void In(float delay, Action<object> callback, object arguments, int iterations, Handle timerHandle = null)
	...
	public static void In(float delay, Action<object> callback, object arguments, int iterations, float interval, Handle timerHandle = null)
	...
	/// </summary>
	private static void Schedule(float time, Action func, Action<object> argFunc, object args, Handle timerHandle, int iterations, float interval)
	{
	...
	private class Event
	{
		...
		public Action<object> ArgFunction = null;
